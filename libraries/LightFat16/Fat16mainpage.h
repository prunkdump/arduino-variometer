 ...
 * Copyright (C) 2008 - 2014 by William Greiman
 *  
...
setting the SPI bus to a lower frequency.  This can be done by using
card.begin(chipSelect, sckDivisor) to initialize the SD card.  Try a value 
of 4 for sckDivisor.  The SPI bus frequency will be F_CPU/sckDivisor.
